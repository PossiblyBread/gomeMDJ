                    ...
                    <div class="popup" id="details-popup-<?php echo $row['id']; ?>">
                        <div class="popup-content">
                            ...
                            <div class="details-section">
                                <p>
                                <h4><strong>Brand and Model:</strong></h4> <?php echo htmlspecialchars($row['p_brand']) . ' ' . htmlspecialchars($row['p_model']); ?></p>
                                <p>
                                <h4><strong>Year:</strong></h4> <?php echo htmlspecialchars($row['p_year']); ?></p>
                                <p>
                                <h4><strong>Type:</strong></h4> <?php echo htmlspecialchars($row['p_type']); ?></p>
                            </div>
