...
<body>
        ...
        <section class="product-grid">
            ...
            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                <div class="product-card">
                    ...
                    <div id="logged-store-image-modal" class="logged-store-image-modal" onclick="closeImageModal()">
                        <span class="modal-overlay"></span>
                        <img id="logged-store-enlarged-image" src="" alt="Enlarged Image" style="max-width: 100%; max-height: 90vh; margin: auto; display: block;">
                    </div>

                    <button class="more-details-btn" onclick="openPopup('<?php echo $row['id']; ?>')">More Details</button>
                    <!-- Popup for More Details -->
                    <div class="logged-store-popup" id="logged-store-details-popup-<?php echo $row['id']; ?>">
    ...
    <script>
        function openPopup(id) {
            const popup = document.getElementById('logged-store-details-popup-' + id);
        ...
        function openImageModal(imageSrc) {
            const modal = document.getElementById('logged-store-image-modal');
            const enlargedImage = document.getElementById('logged-store-enlarged-image');
