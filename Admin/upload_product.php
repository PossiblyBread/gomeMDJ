<!-- Needs new UI design -->
<!-- needs to only accepts .png image format -->
<!-- Upload Configuration needed // Type of Product - might need to add another column in the data table (probably) ¯\_(ツ)_/¯ -->
<!-- Css is Messing with the side-nav -->
<?php
    include "../db_conn.php";
    session_start();
?>
    ...
    <body>
        ...
        <form action="../db_conn.php" method="post" class="product-form" id="productForm" enctype="multipart/form-data">
            ...
            <div class="file-upload">
                <h4>Upload Image</h4>
                <input type="file" name="images" class="form-control" accept=".png" title="Upload Image" id="images" required />
            </div>
            <h4>Basic Info</h4>
            ...
            <a href="upload_product.php" class="cancel-button">Cancel</a>
        </form>
    </body>
</html>
<style>
